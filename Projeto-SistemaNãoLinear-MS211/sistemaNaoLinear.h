...
class SistemaNaoLinear
{
	private:
		...
		bool print; /// <value> Armazena a opção de printar os resultados </value>
		...
		/// <summary> Imprime o valor da iteração atual </summary>
		void printX();
	public:
		...
		/// <param name="erroMax"> O erro máximo do sistema, 0 para não usar </param>
		void setLinear(int nIteracaoMax, double erroMax);
		
		/// <summary> Define se deverá printar os valores das iterações </summary>
		/// <param name="print"> True se deverá printar, false caso contrário </param>
